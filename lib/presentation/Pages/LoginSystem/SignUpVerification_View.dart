import 'package:defioptimized_yield/presentation/Pages/LoginSystem/SignUpSetPassword_View.dart';
...
import 'ForgotPassword_View/Widgets/OtpTimer_Widget.dart';
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            GestureDetector(
              onTap: () {
                Get.to(const SignUpSetPasswordScreen());
              },
              child: Align(
